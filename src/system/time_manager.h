...
void     timeSetDate(uint8_t d, uint8_t mon, uint16_t y);  // установить дату
uint8_t  timeGetD();                                        // текущий день 1–31
uint8_t  timeGetMon();                                      // текущий месяц 1–12
uint16_t timeGetY();                                        // текущий год
String   timeGetDateString();                               // "DD.MM.YYYY"
