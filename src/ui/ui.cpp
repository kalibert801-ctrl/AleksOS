...
static const int _catItems[][8] = {
    { 0, 4, 7, 34, 35, -1, -1, -1 },           // 0: Display  (gi=34=Rotation, gi=35=Btn D-pad)
...
static String settingValue(int gi) {
    ...
    switch(gi) {
        ...
        case 34: return settings.screenFlip ? "Flipped" : "Normal";  // Screen rotation
        case 35: return settings.btnFlip    ? "Flipped" : "Normal";  // Btn D-pad
        case 31: {  // Turbo Mode
...
static void settingInc(int gi) {
    switch(gi) {
        ...
        case 35: settings.btnFlip    = !settings.btnFlip;    break; // Btn D-pad
