...
#define FIRMWARE_VERSION "AleksOS BETA v15.53"
...
#define BTN_IDX_A     3   // бит 3 = 0x08  (физически A на Pico)
#define BTN_IDX_B     2   // бит 2 = 0x04  (физически B на Pico)
#define BTN_IDX_SEL   1   // бит 1 = 0x02
#define BTN_IDX_STA   0   // бит 0 = 0x01
...
// Калибровочный коэффициент АЦП: компенсирует нелинейность ESP32 ADC.
