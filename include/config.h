...
#define FIRMWARE_VERSION "AleksOS BETA v14.78"
...
#define BAT_R_TOP  470000     // верхний резистор делителя (Ом) — 470кОм: ток 3.9мкА
#define BAT_R_BOT  470000     // нижний резистор делителя (Ом) — vs 100кОм = 18.5мкА
